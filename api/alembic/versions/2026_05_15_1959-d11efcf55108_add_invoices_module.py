...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "transaction_date", sa.Date(), nullable=False, comment="Invoice issue date"
        ),
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_invoices_ck_invoices_discount_type_consistency"),
        ),
        sa.CheckConstraint(
            "status IN ('draft', 'sent', 'partial', 'paid', 'overdue', 'canceled')",
            name=op.f("ck_invoices_ck_invoices_valid_status"),
        ),
        sa.CheckConstraint(
            "amount_paid >= 0",
            name=op.f("ck_invoices_ck_invoices_amount_paid_non_negative"),
        ),
        sa.CheckConstraint(
            "balance_due >= 0",
            name=op.f("ck_invoices_ck_invoices_balance_non_negative"),
        ),
        sa.CheckConstraint(
            "due_date >= transaction_date",
            name=op.f("ck_invoices_ck_invoices_due_after_transaction"),
        ),
        sa.CheckConstraint(
            "subtotal >= 0", name=op.f("ck_invoices_ck_invoices_subtotal_non_negative")
        ),
        sa.CheckConstraint(
            "total_due >= 0", name=op.f("ck_invoices_ck_invoices_total_non_negative")
        ),
    ...
    op.create_index(
        op.f("ix_invoices_transaction_date"),
        "invoices",
        ["transaction_date"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "description", sa.Text(), nullable=False, comment="Line item description"
        ),
        sa.Column(
            "quantity",
        ...
        sa.CheckConstraint(
            "line_total >= 0",
            name=op.f("ck_invoice_line_items_ck_line_items_total_non_negative"),
        ),
        sa.CheckConstraint(
            "quantity > 0",
            name=op.f("ck_invoice_line_items_ck_line_items_quantity_positive"),
        ),
        sa.CheckConstraint(
            "tax_amount >= 0",
            name=op.f("ck_invoice_line_items_ck_line_items_tax_non_negative"),
        ),
        sa.CheckConstraint(
            "unit_price >= 0",
            name=op.f("ck_invoice_line_items_ck_line_items_price_non_negative"),
        ),
        sa.ForeignKeyConstraint(
            ["invoice_id"],
            ["invoices.id"],
    ...
    op.create_index(
        "ix_line_items_invoice_id", "invoice_line_items", ["invoice_id"], unique=False
    )
    op.create_table(
        "payments",
        sa.Column(
        ...
        sa.CheckConstraint(
            "amount > 0", name=op.f("ck_payments_ck_payments_amount_positive")
        ),
        sa.ForeignKeyConstraint(
            ["invoice_id"],
            ["invoices.id"],
