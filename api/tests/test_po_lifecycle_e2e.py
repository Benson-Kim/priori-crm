"""end-to-end lifecycle & calculation-parity suite.
...
- calculation parity with the shared app.common.financial engine.
...
class TestCalculationParity:
    ...
    def test_multi_item_matches_financial_engine(self) -> None:
        ...
        # directly, delegating to the same helpers (no local calc), so
