...
class DocumentPDFGenerator:
    ...
    def generate_quote_pdf(self, quote) -> bytes:
        """Return PDF bytes for a quote ORM object."""
        return self._build_pdf(
            doc_type="QUOTE",
    ...
    def _build_pdf(
        ...
        *,
        ...
        # header 
        elements.append(Paragraph(settings.APP_NAME, _HEADER_STYLE))
        ...
        footer_text = f"Generated by {settings.APP_NAME} • {date.today().strftime('%d %b %Y')}"
