...
import { AgeRibbon } from "../components/AgeRibbon";
...
const TABLE_OVERRIDES =
    "[&_th]:bg-desk-surface [&_th]:text-[13px] [&_th]:text-desk-ink [&_th]:py-3 [&_table]:min-w-[1240px]";
        ...
        () => [
            {
                ...
                render: (deal) => (
                    <span className="flex items-start gap-2.5">
                        <RepAvatar initials={deal.owner_initials} color={deal.owner_color} />
            ...
            },
            {
                ...
                render: (deal) => <AgeRibbon deal={deal} />,
            },
            {
                key: "value",
                header: "Value / yr",
                ...
                render: (deal) => (
                    <span className="text-[13px] font-bold text-desk-ink">
            ...
            },
            {
                ...
                render: (deal) => <StageBar deal={deal} />,
            },
            {
                key: "record",
                ...
                render: (deal) => (
                    <>
                        <p className="line-clamp-2 text-xs leading-relaxed text-desk-ink">
                            {deal.latest_record.note}
                        </p>
                ...
                <div className="shrink-0 overflow-hidden rounded-2xl border border-desk-border bg-desk-surface">
                    <div className="flex flex-wrap items-center gap-3 border-b border-desk-border px-4 py-3">
                        ...
                        <SearchInput
                            ...
                            className="w-48 bg-desk-bg px-3 py-1.5 [&_input]:text-xs [&_svg]:size-4"
                        />
