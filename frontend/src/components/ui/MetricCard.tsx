...
export const MetricCard = ({ label, value, change }: MetricCardProps) => (
  <div className="relative flex flex-col justify-between rounded-2xl border border-gray-200 bg-white bg-linear-to-br from-white/25 via-white/10 to-white/05 px-6 py-3 backdrop-blur-md shadow-[4px_4px_4px_0px_rgba(0,0,0,0.02)]">
